...
import { SidebarTabs, type SidebarTabId } from "../navigation/SidebarTabs";
      ...
      {activeTab === "files" && (
        <div className="flex-1 overflow-hidden">
          <div className="flex flex-col items-center justify-center h-full px-4 text-center">
            <FolderTree size={20} className="mb-2 text-muted/40" />
            <p className="text-[10px] text-muted">
              File tree browser coming soon.
            </p>
            <p className="text-[10px] text-muted mt-1">
              Use the Search tab to find and open files.
            </p>
          </div>
        </div>
      )}
